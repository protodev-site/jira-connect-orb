...
@test "3: Execution of Notify Script Works with env vars" {
  ...
  export CIRCLE_PROJECT_USERNAME="protodev-site"
  export CIRCLE_SHA1="aef3425"
  export CIRCLE_PROJECT_REPONAME="jira-connect-orb"
  export CIRCLE_REPOSITORY_URL="https://github.com/protodev-site/jira-connect-orb"
  export CIRCLE_COMPARE_URL="https://github.com/protodev-site/jira-connect-orb"
